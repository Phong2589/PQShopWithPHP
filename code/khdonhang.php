...
<html lang="en">
  ...
  <body>
	...
	<?php
	  ...
	  $sql="SELECT * FROM donhang WHERE (idkh=$idkh and (xacnhankh='Đang xử lí' or trangthai='Đang xử lí'))";
	  ...
	  if($result->num_rows > 0)
{
	...
	while($row = $result->fetch_assoc())
	{
		...
		if($row['trangthai'] == "Hoàn thành") echo "<tr class='hoanthanh'>";
			...
			<td><center><button class='botron'><a href='./khhoanthanh.php?iddh=".$row['iddh']."' style='text-decoration: none;' onclick='return hoanthanh()' class='hoanthanhdon'>Hoàn thành<a></button></center></td>
			<td><center><button class='botron'><a href='./khhuydon.php?iddh=".$row['iddh']."' style='text-decoration: none;' onclick='return huydon()' class='xemchitiet'>Hủy đơn<a></button></center></td>
			</tr>";
	}
