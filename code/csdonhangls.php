...
<html lang="en">
  ...
  <body>
	...
	<?php
	  ...
	  $sql="SELECT * FROM donhang WHERE (idcs=$idcs and ((xacnhankh='Hoàn thành' and trangthai='Hoàn thành') or (xacnhankh='Hủy đơn' and trangthai='Hủy đơn'))) ORDER BY tgcs DESC";
