...
<html lang="en">
  ...
  <body>
	...
	<form action="csxulydoimk.php" style="background-color: #DDD6D6; border-radius: 30px;" method="post" onsubmit="return kiemtra()"> 
	<table cellpadding="12" align="center">
	  ...
	  <script>
		  ...
		  function ktmk(str)
			...
			xmlhttp.open("GET","csktmk.php?mk="+str,true);
			xmlhttp.send();
			}
	  </script>
  </body>
