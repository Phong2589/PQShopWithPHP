...
<html lang="en">
  ...
  <body>
	...
	<form action="khachhangxulycapnhat.php" style="background-color: #DDD6D6;border-radius: 40px;" method="post" onsubmit="return kiemtra()"> 
	<table cellpadding="12" align="center">
		...
		<tr>
			<td><input type="submit" value="Cập nhật" align="middle" class="botron"></td>
			<td>
