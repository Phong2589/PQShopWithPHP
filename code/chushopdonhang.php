...
<html lang="en">
  ...
  <body>
	...
	<div class="cachnav">
	  ...
	  $sql="SELECT * FROM donhang WHERE (idcs=$idcs and (trangthai='Đang xử lí' or xacnhankh='Đang xử lí'))";
	  ...
	  if($result->num_rows > 0)
{
	...
	while($row = $result->fetch_assoc())
	{
		...
		<td><center><button class='botron'><a href='./cshoanthanh.php?iddh=".$row['iddh']."' style='text-decoration: none;' onclick='return hoanthanh()' class='hoanthanhdon'>Hoàn thành<a></button></center></td>
		<td><center><button class='botron'><a href='./cshuydon.php?iddh=".$row['iddh']."' style='text-decoration: none;' onclick='return huydon()' class='xemchitiet'>Hủy đơn<a></button></center></td>
		</tr>";
	}
...
else 
{
	...
	?>
	  ...
	  <script>
	  	function hoanthanh()
		  {
			  var tb = confirm("Bạn có chắc muốn xác nhận hoàn thành!");
			  if(tb==1) return true;
			  else return false;
		  }
		  function huydon()
