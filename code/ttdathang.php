...
<html lang="en">
  ...
  <body>
	...
	?>
	<div id="formdangki">
	<h2 style="text-align: center;">Điền vào thông tin mua hàng!</h2>

	<form action="<?php echo $link; ?>" style="background-color: #DDD6D6;border-radius: 40px;" method="post" onsubmit="return kiemtra()"> 
	<table cellpadding="12" align="center">
		...
		<tr>
			...
			<td>
				<textarea placeholder="Ghi chú" cols="30" rows="3" id="ghichu" name="ghichu">
				
				</textarea>
			</td>
		</tr>
		<tr>
			<td><input type="submit" value="Xác nhận" align="middle" class="botron"></td>
			<td>
